...
public class GUI_DanhSachTour extends JFrame implements ActionListener{
	...
	private JButton btnDatTour,btnTimKiem,btnDatLai,btnTimKiemnhanh,btnXemChiTiet;
...
//		});
		...
		btnXemChiTiet.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				split.setTopComponent(BoxMoTaTour());
			}
		});
	...
	public Box BoxTopTimKiem() {
		...
		ImageIcon icon =  new ImageIcon("icon/refresh-button.png");
		...
		b1.add(btnTimKiemnhanh =  new JButton());
		ImageIcon icontimkiem =  new ImageIcon("icon/search.png");
		...
		btnTimKiemnhanh.setIcon(icontimkiem);
		btnTimKiemnhanh.setBackground(Color.WHITE);
		//		btnTimKiemnhanh.setBorder(new LineBorder(Color.WHITE));
		//btnTimKiemnhanh.setBackground(new Color(0,0,0,0));
		// btnTimKiemnhanh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/searcher.png"))); // NOI18N
		btnTimKiemnhanh.setBorder(null);

		B1.add(b1 = Box.createVerticalBox());
		B1.add(b1 = Box.createHorizontalBox());
		...
		//lblNoiKhoiHanh.setPreferredSize(dim);
...
private Box BoxTopMoTaTour() {
	...
	ImageIcon iconQuayLait =  new ImageIcon("icon/iconsback.png");
	...
	ImageIcon iconHoatDong =  new ImageIcon("icon/iconsback.png");
	...
	lblChoTong.setIcon(new ImageIcon("/icon/event.png"));
	b1.add(Box.createHorizontalStrut(20));
