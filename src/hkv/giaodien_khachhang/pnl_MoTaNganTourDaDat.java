...
public class pnl_MoTaNganTourDaDat extends JPanel  implements ListCellRenderer<Tour>{
...
//				);
	...
	public Component getListCellRendererComponent(JList<? extends Tour> list, Tour value, int index, boolean isSelected,
		...
		this.lblGheTrong.setText("Số Lượng:  "+value.getSoTrong());
