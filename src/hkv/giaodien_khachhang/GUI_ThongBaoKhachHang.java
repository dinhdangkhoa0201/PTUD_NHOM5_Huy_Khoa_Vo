...
public class GUI_ThongBaoKhachHang extends JFrame implements TableCellRenderer{
	...
	public GUI_ThongBaoKhachHang() {
		setDefaultCloseOperation(EXIT_ON_CLOSE);
		setResizable(false);
		setLocationRelativeTo(null);
	}

	public Box BoxMainThongBao() {
		JSplitPane split1;
		...
		split1.setRightComponent(ListThongBao());
	...
	public Box BopTop() {
		...
		b1.add(lblTitle = new JLabel("THÔNG BÁO CHO KHÁCH HÀNG"));
	...
	public JList<Tour> ListThongBao() {
		Icon image;
...
//		defaultListModel.addElement(new Tour("HCM_DN_001", "Hồ Chí Minh - Đà Nẵng","21-9-2019","30-9-2019","Ô Tô", 9800000, "img/hinh1.jfif", "4"));
		...
		list.setCellRenderer(new pnl_ThongBao());
